...
## Status
**In progress** - parity implementation is underway from highest priority to lowest priority. `ccgram_feature_parity_plan.md` is the tracker of record and implementation journal. FP-01 through FP-09, FP-17, and FP-18 are complete and merged to `main`. The next highest-priority unfinished feature is FP-11 `/send` file browser/upload.
